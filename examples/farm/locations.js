...
локация.погреб = {
    ...
    выходы: () => [
        ["лестницу", локация.конюшня],
        ["по лестнице", локация.конюшня]
    ]
}
...
локация.дорога = {
    ...
    выходы: () => [
        ["востока", локация.тупик],
        ["запад", локация.уВорот],
