...
локация.амбар = {
    объекты: "лопата",
    изображение: "barn_inside_shovel.jpg",
...
локация.конюшня = {
    ...
    выходы: [
        ["выйти", "поле"],
        ["ступени/спуститься вниз", "погреб"],
        ["на чердак", "чердак"]
    ]
}
...
локация.погреб = {
    ...
    изображение: (погреб) => {
        if(светло(погреб)) {
            if (объект.сейф.открыт) {
                return объект.сейф.содержит(предмет.шкатулка)
                    ? "stable_basement_casket.jpg"
                    : "stable_basement_empty.jpg"
            }
            return "stable_basement_lit.jpg"
        } else {
...
локация.дорога = {
    ...
    описание: "Эта очень узкая дорога ведет с *востока* на *север*. Но, кажется, можно пройти и *на запад*.",
    выходы: [
        ["на запад", "тупик"],
        ["востока", "уВорот"],
        ["север", "поле"],
...
локация.уВорот = {
    объекты: "ворота",
    изображение: () => объект.ворота.открыты ? "gates_opened.jpg" : "gates_closed.jpg",
