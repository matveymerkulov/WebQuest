...
локация.порог = {
    объекты: "дверь",
    изображение: () => объект.дверь.закрыта ? "door_closed.jpg" : "door_opened.jpg",
...
локация.уВорот = {
    объекты: "ворота",
    изображение: () => объект.ворота.закрыты ? "gates_closed.jpg" : "gates_opened.jpg",
...
локация.сад = {
    объекты: ["ворота", "яма"],
    изображение: () => "garden" + (объект.ворота.закрыты ? "" : "_opened")
