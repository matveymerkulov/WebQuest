...
import {Локация} from "../../src/init.js"

локация.начало = Object.assign(new Локация(), {
...
локация.авторы = Object.assign(new Локация(), {
    изображение: "intro.jpg",
    описание:
...
локация.амбар = Object.assign(new Локация(), {
    объекты: "лопата",
...
локация.двор = Object.assign(new Локация(), {
...
локация.конюшня = Object.assign(new Локация(), {
...
локация.чердак = Object.assign(new Локация(), {
...
локация.поле = Object.assign(new Локация(), {
    выкопанаЯма: нет,
...
локация.порог = Object.assign(new Локация(), {
    объекты: "дверь",
...
локация.прихожая = Object.assign(new Локация(), {
    объекты: ["дверь", "буфет"],
...
локация.гостиная = Object.assign(new Локация(), {
    объекты: "факел",
...
локация.столовая = Object.assign(new Локация(), {
    объекты: "плед",
...
локация.кухня = Object.assign(new Локация(), {
...
локация.погреб = Object.assign(new Локация(), {
    объекты: "сейф",
    изображение: (погреб) => {
        if(светло(погреб)) {
...
локация.тупик = Object.assign(new Локация(), {
...
локация.дорога = Object.assign(new Локация(), {
...
локация.уВорот = Object.assign(new Локация(), {
    объекты: "ворота",
...
локация.сад = Object.assign(new Локация(), {
    объекты: ["ворота", "яма"],
...
локация.конец = Object.assign(new Локация(), {
    плед: нет,
