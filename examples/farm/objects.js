...
объект.дверь = {
    ...
    название: (дверь) => (дверь.открыта ? ["открытая дверь", "открытую дверь"]
        : ["закрытая дверь", "закрытую дверь"]),
    команды: [
        {
            текст: "осмотреть",
            выполнение: (дверь) => {
...
объект.буфет = {
    ...
    название: (буфет) => (буфет.открыт ? "открытый " : "закрытый ") + "буфет",
    команды: [
        {
            текст: "открыть",
...
объект.сейф = {
    ...
    объекты: "шкатулка",
    название: (сейф) => (сейф.открыт ? "открытый " : "закрытый ") + "сейф",
    команды: [
        {
            текст: "отпереть/ключом",
            условие: (сейф) => игрок.имеет(предмет.ключ) && !сейф.открыт && сейф.заперт,
            выполнение: (сейф) => {
...
объект.ворота = {
    ...
    название: (ворота) => (ворота.открыты ? "открытые " : "закрытые ") + "ворота",
    команды: [
        {
