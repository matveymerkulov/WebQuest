...
объект.дверь = {
    ...
    название: (дверь) => (дверь.открыта ? ["открытая дверь", "открытую дверь"] : "дверь"),
    команды: [
        {
            текст: "осмотреть",
            выполнение: (дверь) => {
...
объект.буфет = {
    ...
    название: (буфет) => (буфет.открыт ? "открытый " : "") + "буфет",
    команды: [
        {
            текст: "открыть буфет",
...
объект.сейф = {
    ...
    название: (сейф) => (сейф.открыт ? "открытый " : "") + "сейф",
    команды: [
        {
...
объект.ворота = {
    ...
    название: (ворота) => (ворота.открыты ? "открытые " : "") + "ворота",
    команды: [
        {
